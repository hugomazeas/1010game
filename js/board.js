        ...
        for (let x = 0; x < this.height; x++) {
            for (y = 0; y < this.width; y++) {
                if (this.board[x][y] == false)
                    $(".board_container").append(`<div id='${x.toString() + y.toString()}' class='box'>${x.toString() + y.toString()}</div>`);
                else
                    $(".board_container").append(`<div id='${x.toString() + y.toString()}' class='box busy'>${x.toString() + y.toString()}</div>`);
            }
        }
    }
    update_board() {
